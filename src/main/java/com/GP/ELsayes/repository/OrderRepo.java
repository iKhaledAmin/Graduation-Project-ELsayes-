...
public interface OrderRepo extends JpaRepository<Order,Long> {
    ...
    @Query("SELECT o FROM Order o JOIN o.servicesOfOrder so WHERE so.service.id = :serviceId " +
            "AND o.progressStatus = 'UN_CONFIRMED'")
    Optional<Order> findUnConfirmedByServiceId(Long serviceId);
